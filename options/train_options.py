...
class TrainOptions:
    def __init__(self):
        ...
        # dataset parameters
        parser.add_argument("--ph_train_root", type=str, help="the root directory of train photo")
        parser.add_argument(
            "--sk_train_root", type=str, help="the root directory of train sketch"
        )
        parser.add_argument("--ph_test_root", type=str, help="the root directory of test photo")
        parser.add_argument("--sk_test_root", type=str, help="the root directory of test sketch")
        # model parameters
        ...
        parser.add_argument(
            "--match",
            type=str,
            help="choose the match method, 'dla' or 'la'",
        )
